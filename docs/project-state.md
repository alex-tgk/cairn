...
- Release: `https://github.com/alex-tgk/cairn/releases/tag/v0.3.0`
...
- Verification: 193 tests, type checking, compiled-binary smoke test, and green macOS, Linux, and Windows CI
